...
from math_datasets.generators import Generate, generate_responses, TransformersGenerate, ReWOOGenerate
...
if __name__ == "__main__":
    ...
    if args.model_name is None:
        ...
        all_model_names = [get_model_name_identifer(model_name, fine_tuned=False) for model_name in models] + \
